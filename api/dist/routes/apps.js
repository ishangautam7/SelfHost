...
router.post('/', async (req, res) => {
    try {
        ...
        const pool = (0, db_1.getPool)();
        await pool.query('INSERT INTO apps (id, user_id, name, subdomain, local_port, resource_cpu, resource_memory) VALUES ($1, $2, $3, $4, $5, $6, $7)', [id, userId, name, subdomain, local_port, cpu, memory]);
